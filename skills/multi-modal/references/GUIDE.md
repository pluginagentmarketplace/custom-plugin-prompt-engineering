...
This guide provides comprehensive documentation for the **multi-modal** skill in the custom-plugin-prompt-engineering plugin.
...
```bash
# Invoke the skill
claude "multi-modal - [your task description]"

# Example
claude "multi-modal - analyze the current implementation"
```
...
def implement_multi_modal(input_data):
    """
    Implement multi-modal functionality.
