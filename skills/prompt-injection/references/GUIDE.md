...
This guide provides comprehensive documentation for the **prompt-injection** skill in the custom-plugin-prompt-engineering plugin.
...
```bash
# Invoke the skill
claude "prompt-injection - [your task description]"

# Example
claude "prompt-injection - analyze the current implementation"
```
...
def implement_prompt_injection(input_data):
    """
